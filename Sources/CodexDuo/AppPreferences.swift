...
final class AppPreferences {
    ...
    private enum Key {
        ...
        static let customProxyURL = "customProxyURL"
    ...
    var customProxyURL: String {
        get { self.defaults.string(forKey: Key.customProxyURL) ?? "" }
        set {
            self.defaults.set(newValue.trimmingCharacters(in: .whitespacesAndNewlines), forKey: Key.customProxyURL)
            self.notifyChange()
        }
    }
